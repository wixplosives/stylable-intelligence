...
describe('Completions', () => {
    ...
    describe('Multiple Files', () => {
        it('complete states for localy imported component', () => {
            return asserters.getCompletions('states/locally-imported-component.st.css').then(asserter => {
                asserter.suggested([
        ...
        it('complete states for localy imported component (including local states)', () => {
            return asserters.getCompletions('states/locally-imported-component-with-states.st.css').then(asserter => {
                asserter.suggested([
        ...
        it('complete states for localy imported component ( recursive )', () => {
            return asserters.getCompletions('states/locally-imported-component-recursive.st.css').then(asserter => {
                asserter.suggested([
    ...
    // describe.only('Missing Files', () => {
    //     it('Should not break when import file is missing', () => {
