...
describe('States', () => {
    describe('Local states', () => {
        ...
        [str1, str2].forEach((str, j, a) => {
            str.split('').forEach((c, i) => {
                ...
                it('should complete available states from same file, with prefix ' + prefix + ' ', () => {
                ...
                it('should complete available states in complex selectors, with prefix ' + prefix + ' ', () => {
    ...
    describe('Imported states', () => {
        ...
        [str1, str2].forEach((str, j, a) => {
            str.split('').forEach((c, i) => {
                const prefix = str.slice(0, i);
                it('should complete state ' + str + ' after pseudo-element, with prefix ' + prefix + ' ', () => {
