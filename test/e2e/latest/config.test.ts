...
suite('configuration', function () {
    ...
    async function getWorkingDocument(...testSubPath: string[]) {
        const casesPath = path.join(rootDir!, 'fixtures', 'latest', ...testSubPath);
    ...
    test('should have experimentalSelectorInference=true for version greater then 6 by default', async () => {
